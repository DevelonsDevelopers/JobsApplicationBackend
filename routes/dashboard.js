...
router.get('/api/dashboard/companyDashboard', dashboardController.getCompanyDashboard);
...
router.get('/api/dashboard/companyLineChart', dashboardController.getCompanyLineChart);
