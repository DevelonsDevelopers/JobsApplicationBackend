...
<body>
    <div
        style="background-color: rgb(231, 231, 231); border: 1px solid black; border-radius: 20px; padding: 4%; margin: 5%;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
        <center>
            <h2>${name}</h2>
            <h2>${role}</h2>
